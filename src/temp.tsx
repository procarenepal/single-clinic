    ...
    selectedRecipientType === "patient"
      ...
      : selectedRecipientType === "doctor"
        ? availableDoctors.map((d) => ({
          ...
          primary: d.name,
          secondary:
            `${d.phone || ""}${d.speciality ? ` ΓÇó ${d.speciality}` : ""}`.trim() ||
            undefined,
        }))
    ...
    <div className="space-y-4">
      ...
      <div className="clarity-card p-3 bg-[rgb(var(--color-surface-2))]">
        ...
        <ul className="text-xs space-y-1 text-[rgb(var(--color-text-muted))]">
          <li>ΓÇó Phone numbers are automatically validated</li>
          <li>ΓÇó SMS is sent instantly using direct service</li>
          <li>
            ΓÇó Messages over 160 characters will be split into multiple SMS
          </li>
          <li>
            ΓÇó All SMS activity is logged and can be viewed in SMS Logs tab
          </li>
        </ul>
      </div>
    </div>
