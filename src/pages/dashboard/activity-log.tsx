      ...
      <div className="bg-surface border border-border-base rounded-2xl overflow-hidden shadow-sm">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <p className="text-[14px] text-text-main font-bold">
              No activity found
            </p>
            ...
            {activities.map((item) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div
                    className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 ${item.color.replace("bg-", "bg-opacity-10 text-").replace("500", "600")} ${item.color.replace("500", "100")} dark:bg-opacity-20`}
                  >
                    {item.icon}
                  </div>
