...
function Eyebrow({ children }: { children: ReactNode }) {
  return (
    <div
      ...
      style={{ background: "rgba(var(--color-primary),0.08)", border: "1px solid rgba(var(--color-primary),0.18)" }}
    >
  ...
  return (
    <>
      <div
        ...
        style={{ background: "rgb(var(--color-primary))", filter: "blur(100px)" }}
      />
      <div
        ref={blobB}
  ...
  return (
    <div className="min-h-screen" style={{ background: "rgb(var(--color-bg))", color: "rgb(var(--color-text))" }}>
      ...
      <section
        ...
        style={{ background: "linear-gradient(180deg, rgb(var(--color-surface)) 0%, rgb(var(--color-bg)) 100%)" }}
      >
        <HeroBlobs />
        ...
        <div className="relative max-w-7xl mx-auto px-5 lg:px-8 pt-10 lg:pt-24 pb-24 lg:pb-36 flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
          ...
          <Reveal className="flex-1 max-w-xl text-center lg:text-left">
            ...
            <h1
              ...
              style={{ ...SERIF, fontWeight: 600, color: "rgb(var(--color-text))" }}
            >
              {content.hero.title}
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-10 items-center lg:items-start">
              <Link
                ...
                style={{ background: BRAND_GRADIENT, boxShadow: "0 16px 32px -12px rgba(var(--color-primary),0.55)" }}
              >
            ...
            <div
              ...
              style={{ background: "rgb(var(--color-surface))", border: "1px solid rgb(var(--color-border))", boxShadow: "0 12px 28px -18px rgba(0,0,0,0.35)" }}
            >
              ...
              <div className="w-px h-8 flex-shrink-0" style={{ background: "rgb(var(--color-border))" }} />
          ...
          <Reveal direction="scale" delay={150} className="flex-1 w-full max-w-2xl relative">
            <div
              className="hidden lg:block absolute -inset-3 rounded-[2rem] rotate-1"
              style={{ background: "linear-gradient(135deg, rgba(var(--color-primary),0.16), rgba(var(--color-primary),0.02))" }}
            />
            <div
              className="relative rounded-[1.75rem] overflow-hidden"
              style={{ background: "rgb(var(--color-surface))", boxShadow: "0 32px 64px -24px rgba(0,0,0,0.35)" }}
            >
            ...
            <div
              ...
              style={{ background: "rgb(var(--color-surface))", border: "1px solid rgb(var(--color-border))", boxShadow: "0 16px 32px -16px rgba(0,0,0,0.35)" }}
            >
              ...
              <div>
                <p className="text-sm font-extrabold leading-none" style={{ color: "rgb(var(--color-text))" }}>4.9/5</p>
                <p className="text-[10px] font-semibold uppercase tracking-wide mt-0.5" style={{ color: "rgb(var(--color-text-muted))" }}>Patient Rating</p>
              </div>
            </div>
            ...
            <div
              ...
              style={{ background: "white", padding: "10px 10px 34px", borderRadius: "4px", boxShadow: "0 24px 48px -16px rgba(0,0,0,0.45)" }}
            >
              <div className="w-full aspect-square rounded-sm overflow-hidden">
                <img alt="Specialist" className="w-full h-full object-cover" src="/images/team_1.png" />
              </div>
              <p className="absolute bottom-2 left-0 right-0 text-center text-[10px] font-semibold" style={{ ...SERIF, fontStyle: "italic", color: "#333" }}>
                Dr. Park
              </p>
            </div>
          </Reveal>
      ...
      ───────────────────────────────────────────────────────────────────── */}
      <Reveal delay={100} className="relative z-10 max-w-6xl mx-auto px-5 lg:px-8 -mt-10 lg:-mt-16">
        <div
          className="rounded-2xl lg:rounded-[1.75rem] overflow-hidden"
          style={{ background: "rgb(var(--color-surface))", border: "1px solid rgb(var(--color-border))", boxShadow: "0 24px 48px -20px rgba(0,0,0,0.25)" }}
        >
          <div className="grid grid-cols-2 lg:grid-cols-4 divide-x divide-y lg:divide-y-0 divide-[rgb(var(--color-border))]">
            {content.stats.map((stat, index) => {
              ...
              return (
                <div key={index} className="flex items-center gap-4 px-4 sm:px-6 lg:px-8 py-8 lg:py-10">
                  <div
                    className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0"
                    style={{ background: BRAND_GRADIENT, boxShadow: "0 8px 16px -6px rgba(var(--color-primary),0.5)" }}
                  >
                    <IconComponent className="w-5 h-5 text-white" />
                  </div>
                  <div>
                    <p className="text-2xl sm:text-3xl font-extrabold tabular-nums tracking-tight" style={{ color: "rgb(var(--color-text))" }}>
                      {stat.number}
                    </p>
                    <p className="text-[11px] sm:text-xs font-semibold mt-0.5 leading-snug uppercase tracking-wide" style={{ color: "rgb(var(--color-text-muted))" }}>
                      {stat.label}
                    </p>
                  </div>
                </div>
      ...
      <section className="pt-20 lg:pt-32 pb-10 lg:pb-24 overflow-hidden">
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          ...
          <Reveal className="mb-10 lg:mb-20 text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl mb-4 leading-tight tracking-tight" style={{ ...SERIF, fontWeight: 600, color: "rgb(var(--color-text))" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {content.services.map((service, index) => {
              ...
              return (
                <Reveal key={index} delay={index * 90} direction={index % 2 === 1 ? "left" : "right"} className={stagger}>
                  <div
                    className="group flex flex-col rounded-2xl overflow-hidden transition-all duration-300 hover:-translate-y-1.5"
                    style={{ background: "rgb(var(--color-surface))", border: "1px solid rgb(var(--color-border))", boxShadow: "0 2px 8px -4px rgba(0,0,0,0.06)" }}
                  >
                    {/* Image */}
                    ...
                    <div className="p-7 flex flex-col flex-1">
                      ...
                      <h3 className="text-lg mb-3 tracking-tight" style={{ ...SERIF, fontWeight: 600, color: "rgb(var(--color-text))" }}>
                        {service.title}
                      </h3>
      ...
      <section className="py-2 lg:py-4 overflow-hidden">
        <Reveal direction="scale" className="max-w-7xl mx-auto px-5 lg:px-8 text-center">
          <p className="text-xs font-bold uppercase tracking-widest mb-6" style={{ color: "rgb(var(--color-primary))" }}>
            The Philosophy
          </p>
          <h2
          ...
          >
            Science meets
            <br />
            <span style={{ fontStyle: "italic", color: "rgb(var(--color-primary))" }}>artistry.</span>
          </h2>
        </Reveal>
      </section>
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center px-7 sm:px-10 lg:px-16">
              <div className="max-w-xs sm:max-w-sm text-white">
                ...
                <h2 className="text-lg sm:text-2xl lg:text-4xl mb-2 sm:mb-4 leading-tight" style={{ ...SERIF, fontWeight: 600 }}>
      ...
      {/* ─────────────────────────────────────────────────────────────────────
          HOW IT WORKS
      ───────────────────────────────────────────────────────────────────── */}
      <section className="py-16 lg:py-24 border-t border-b" style={{ background: "rgb(var(--color-surface))", borderColor: "rgb(var(--color-border))" }}>
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-8">
            {content.process.map((item, i) => (
              <Reveal key={i} delay={i * 120} className="relative flex flex-col">
                <span
                  aria-hidden="true"
                  className="absolute -top-4 -left-1 text-[100px] leading-none select-none pointer-events-none opacity-[0.05]"
                  style={{ ...SERIF, fontWeight: 700, color: "rgb(var(--color-text))" }}
                >
                  {item.step}
                </span>
                ...
                <div className="relative flex items-center gap-4 mb-5">
                  ...
                  {i < content.process.length - 1 && (
                    <div
                      ...
                      style={{ background: "linear-gradient(90deg, rgba(var(--color-primary),0.35), rgba(var(--color-primary),0.03))" }}
                    />
                  )}
                </div>

                {/* Image */}
                <div className="relative aspect-[16/10] rounded-2xl overflow-hidden mb-6" style={{ boxShadow: "0 12px 24px -12px rgba(0,0,0,0.18)" }}>
                  <img
                    alt={item.title}
                ...
                <h4 className="text-lg mb-2" style={{ ...SERIF, fontWeight: 600, color: "rgb(var(--color-text))" }}>
                  {item.title}
                </h4>
      ...
      <section className="py-16 lg:py-24 overflow-hidden">
        <div className="max-w-7xl mx-auto px-5 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          {/* Image */}
          <Reveal direction="left" className="relative mb-6 lg:mb-0">
            <div
              className="hidden lg:block absolute -inset-4 rounded-[2rem] -z-10"
              style={{ background: "linear-gradient(135deg, rgba(var(--color-primary),0.14), rgba(var(--color-primary),0.02))" }}
            />
            <div className="rounded-2xl overflow-hidden" style={{ boxShadow: "0 24px 48px -24px rgba(0,0,0,0.25)" }}>
              <img
            ...
            {content.stats[0] && (
              ...
              >
                ...
                <div>
                  <p className="text-lg font-extrabold leading-none" style={{ color: "rgb(var(--color-text))" }}>
                    {content.stats[0].number}
                  </p>
                  <p className="text-[10px] font-semibold uppercase tracking-wide mt-1" style={{ color: "rgb(var(--color-text-muted))" }}>
          ...
          <Reveal direction="right" delay={120} className="text-center lg:text-left">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl mb-5 tracking-tight leading-[1.1]" style={{ ...SERIF, fontWeight: 600, color: "rgb(var(--color-text))" }}>
              {content.precisionSection.title}
            </h2>
            <p className="text-sm sm:text-base leading-relaxed mb-5 lg:mb-10" style={{ color: "rgb(var(--color-text-muted))" }}>
            ...
            <ul className="space-y-4 lg:space-y-5 text-left">
              {[
                ...
                <li key={i} className="flex items-start gap-3.5">
                  ...
                  >
                    <CheckCircle2 className="w-4 h-4" style={{ color: "rgb(var(--color-primary))" }} />
                  </div>
                  <div>
      ...
      {/* ─────────────────────────────────────────────────────────────────────
          TESTIMONIALS
      ───────────────────────────────────────────────────────────────────── */}
      <section className="py-16 lg:py-24 border-b" style={{ background: "rgb(var(--color-surface))", borderColor: "rgb(var(--color-border))" }}>
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          ...
          <Reveal delay={150} direction="scale" className="min-h-[300px] lg:h-80">
            <Carousel
              ...
              items={testimonials.map((t, i) => (
                <div key={i} className="h-full px-1 sm:px-2">
                  <div
                    ...
                    style={{ background: "rgb(var(--color-bg))", border: "1px solid rgb(var(--color-border))", boxShadow: "0 20px 40px -28px rgba(0,0,0,0.25)" }}
                  >
                    {/* Decorative quote mark */}
                    <span
                      aria-hidden="true"
                      className="absolute top-0 right-4 sm:right-6 text-[100px] sm:text-[140px] leading-none select-none pointer-events-none"
                      style={{ ...SERIF, color: "rgba(var(--color-primary),0.06)" }}
                    >
                      "
                    </span>
                    ...
                    <div className="relative z-10">
                      ...
                      <p
                        ...
                        style={{ ...SERIF, fontStyle: "italic", fontWeight: 500, color: "rgb(var(--color-text))" }}
                      >
                        "{t.text}"
                      </p>
                      ...
                      <div className="flex items-center gap-4">
                        <img
                          ...
                          src={t.image}
                          style={{ border: "2px solid rgb(var(--color-primary))" }}
                        />
                        <div>
                          <div className="flex items-center gap-2">
                            ...
                            <div
                              ...
                              style={{ color: "rgb(var(--color-success))", background: "rgba(var(--color-success),0.1)", border: "1px solid rgba(var(--color-success),0.25)" }}
                            >
      ...
      <section className="py-16 lg:py-24 overflow-hidden">
        <div className="max-w-7xl mx-auto px-5 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
          ...
          <Reveal direction="left" className="text-center lg:text-left">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl mb-8 lg:mb-10 tracking-tight leading-tight" style={{ ...SERIF, fontWeight: 600, color: "rgb(var(--color-text))" }}>
              Visit Our Clinic
            </h2>

            <div
              className="rounded-2xl lg:rounded-3xl p-6 lg:p-8 space-y-5 lg:space-y-6 text-left"
              style={{ background: "rgb(var(--color-surface))", border: "1px solid rgb(var(--color-border))", boxShadow: "0 20px 40px -28px rgba(0,0,0,0.18)" }}
            >
              {[
          ...
          {/* Map placeholder */}
          <Reveal direction="right" delay={120} className="w-full h-[260px] sm:h-[320px] lg:h-[380px] lg:mt-[68px]">
            <div
              className="w-full h-full rounded-2xl lg:rounded-3xl overflow-hidden relative"
              style={{ background: "rgb(var(--color-surface))", border: "1px solid rgb(var(--color-border))", boxShadow: "0 24px 48px -24px rgba(0,0,0,0.25)" }}
            >
              <img
                alt="Clinic"
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-5 p-8 text-center">
                <div
                  ...
                  style={{ background: BRAND_GRADIENT, boxShadow: "0 12px 24px -8px rgba(var(--color-primary),0.5)" }}
                >
      ...
      <section className="py-10 lg:py-24">
        <Reveal direction="scale" className="max-w-7xl mx-auto px-5 lg:px-8">
          <div
          ...
          >
            ...
            <div className="relative z-10 px-5 sm:px-8 py-10 sm:py-20 lg:py-24 text-center text-white max-w-2xl mx-auto">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-6xl mb-3 sm:mb-6 tracking-tight leading-[1.05]" style={{ ...SERIF, fontWeight: 600 }}>
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <Link
                  ...
                  style={{ background: "white", color: "rgb(var(--color-primary))", boxShadow: "0 16px 32px -12px rgba(0,0,0,0.35)" }}
                >
