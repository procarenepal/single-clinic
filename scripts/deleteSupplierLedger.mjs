...
async function main() {
  console.log("🗑  Clearing supplier ledger data...\n");

  await deleteCollection("supplier_ledger_entries");
  await deleteCollection("supplier_purchase_records");
  await deleteCollection("supplier_payments");

  console.log("\n✅ Done — all supplier ledger records cleared.");
}
