...
async function main() {
  console.log("🗑  Clearing billings and related commission data...\n");

  await deleteCollection("appointmentBilling");
  await deleteCollection("doctorCommissions");
  await deleteCollection("expertCommissions");
  await deleteCollection("referralCommissions");
  await deleteCollection("staffCommissions");

  console.log("\n✅ Done — all billings and commissions cleared.");
}
