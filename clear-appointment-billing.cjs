...
(async () => {
  console.log('Starting cleanup of Appointment Invoices and Commissions...');
  
  // Clear the main invoices
  await clearCollection('appointmentBilling');
  
  // Clear associated commissions just to ensure everything is reset cleanly
